...
url_template <- 'https://www.imdb.com/title/tt1267297/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
for (page in 1:pages_to_scrape) {
  ...
  if (length(Title) >= reviews_to_scrape) {
    break
  }
}
```
...
DataFrame <- data.frame(
  Title = rep("Hercules", reviews_to_scrape),
