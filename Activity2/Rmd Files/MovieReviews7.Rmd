...
url_template <- 'https://www.imdb.com/title/tt0449010/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("Eragon", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews7.csv", row.names = FALSE)
```
