...
url_template <- 'https://www.imdb.com/title/tt0363771/reviews/_ajax?ref__=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("The Chronicles of Narnia: The Lion, the Witch and the Wardrobe", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews3.csv", row.names = FALSE)
```
