...
url_template <- 'https://www.imdb.com/title/tt2713180/reviews/_ajax?ref__=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("Fury", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews2.csv", row.names = FALSE)
```
