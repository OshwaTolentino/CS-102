...
url_template <- 'https://www.imdb.com/title/tt1049413/reviews/_ajax?ref__=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("Up", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews4.csv", row.names = FALSE)
```
