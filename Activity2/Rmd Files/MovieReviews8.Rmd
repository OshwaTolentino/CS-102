...
url_template <- 'https://www.imdb.com/title/tt0120804/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("Resident Evil", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews8.csv", row.names = FALSE)
```
