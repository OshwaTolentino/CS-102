...
url_template <- 'https://www.imdb.com/title/tt0800080/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("The Incredible Hulk", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews5.csv", row.names = FALSE)
```
