...
url_template <- 'https://www.imdb.com/title/tt1979388/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("The Good Dinosaur", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews10.csv", row.names = FALSE)
```
