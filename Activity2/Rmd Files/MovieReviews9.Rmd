...
url_template <- 'https://www.imdb.com/title/tt6105098/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("The Lion King", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews9.csv", row.names = FALSE)
```
