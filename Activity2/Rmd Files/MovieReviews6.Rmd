...
url_template <- 'https://www.imdb.com/title/tt0382932/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Title = rep("Ratatouille", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "imdb_reviews6.csv", row.names = FALSE)
```
