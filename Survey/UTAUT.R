...
# Create a new row for the total average
average_row <- c("Total Average", average_mean, average_sd)

# Add the new row to the data frame
total_average <- rbind(read_merged_data, average_row)

# Print the updated data frame
total_average

# Save the new data frame with Total Average as a CSV file
write.csv(total_average, "Merged Data with Total Average.csv", row.names = FALSE)
